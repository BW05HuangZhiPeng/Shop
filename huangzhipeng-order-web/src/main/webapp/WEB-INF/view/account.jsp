                    ...
                    <div class="table-responsive">
                      <table class="table">
                        <thead>
                          <tr>
                            <th colspan="6"> 
                              <ul>
                                <li><span></span></li>
                                <li style="margin-left:120px"><span>订单详情</span></li>
                                <li style="margin-left:200px"><span>收货人</span></li>
                                <li style="margin-left:50px"><span>金额</span></li>
                                <li style="margin-left:50px"><span>小计</span></li>
                                <li style="margin-left:50px"><span>操作</span></li>
                              </ul>
                            </th>
                          </tr>
                        </thead>
                        ...
                        <c:forEach items="${pageInfo.list}" var="order">
                          <tr>
                            <th colspan="6" style="background:#f5f5f5;border-bottom:none;padding:22px 20px"> 
                              <ul>
                                <li><span><fmt:formatDate value="${order.createTime}" pattern="yyyy-MM-dd"/></span></li>
                                <li><span>订单号:</span> <span>${order.orderId}</span></li>
                                <li class="price-box"><span>总价：</span> <span class="price">${order.actualPrice}</span></li>
                                <li><span>状态：</span> <span><c:if test="${order.status==1}">待付款</c:if></span></li>
                              </ul>
                            </th>
                          </tr>
                          ...
                          <tr>
                            <td>
                              <a href="http://localhost:8080/page?id=${orderDetail.skuId}">
                                <div class="product-image">
                                  <img alt="Shopholic" src="pic/${orderDetail.image}">
                                </div>
                              </a>
                            </td>
                            <td>
                              <div class="product-title" style="width:80px"> 
                                <a href="http://localhost:8080/page?id=${orderDetail.skuId}">${orderDetail.title}</a> 
                              </div>
                              <div class="product-info-stock-sku m-0">
                                  <span class="info-deta">${orderDetail.num}</span> 
                              </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <div class="base-price price-box"> 
                                <span class="price">${orderDetail.price * orderDetail.num}</span> 
                              </div>
                            </td>
                            <%-- <td>
                              <i class="fa fa-look"><a href="getOrderById?id=${order.orderId}&skuId=${orderDetail.skuId}">详情</a></i>
                            </td> --%>
                          </tr>
                          </c:forEach>
                          </c:forEach>
