 ...
 * Generated at: 2019-11-22 06:24:05 UTC
...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"f-name\">First Name</label> <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"f-name\" required placeholder=\"First Name\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-box\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"l-name\">Last Name</label> <input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"l-name\" required placeholder=\"Last Name\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-box\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"login-email\">Email address</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"login-email\" type=\"email\" required\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Email Address\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-box\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"telephone\">Telephone</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"telephone\" type=\"email\" required\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Telephone\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-box\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"login-pass\">Password</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"login-pass\" type=\"password\" required\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Enter your Password\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-box\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"re-enter-pass\">Re-enter Password</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"re-enter-pass\" type=\"password\" required\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tfor=\"remember_me\">Remember Me</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<button name=\"submit\" type=\"submit\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"btn-color right-side\">Submit</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<hr>\r\n");
